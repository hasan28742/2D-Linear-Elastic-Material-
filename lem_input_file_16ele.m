...
%total y axies load is (20*2) or 40 which will be devided into 5 nodes leads to 8N per  node
n_bc    = [  21    22    23    24                % node 1
             22    23    24    25                % node 2
             0      0     0     0          % fx value at node 1 
             -20     -20    -20    -20         %fy  at node 1
             0     0     0      0          %fx at node 2
             -20    -20    -20     -20];       % fy value at node 1
...
e_bc_plot    = [  1    6    11    16                % node 1
                  6    11    16    21          % node 2
                  0     0     0    0          % flux value at node 1 
                  0     0     0    0 ];       % flux value at node 2 
number_e_bc = 4;   % number of (elemental) edges on the essential boundary
